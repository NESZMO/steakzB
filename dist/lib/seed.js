...
async function main() {
    ...
    for (const city of cities) {
        ...
        const staff = [
            { suffix: 'manager', role: 'BRANCH_MANAGER', name: `${city} Manager` },
            { suffix: 'chef', role: 'CHEF', name: `${city} Chef` },
            { suffix: 'cashier', role: 'CASHIER', name: `${city} Cashier` },
            { suffix: 'waiter1', role: 'WAITER', name: `${city} Waiter` },
        ];
