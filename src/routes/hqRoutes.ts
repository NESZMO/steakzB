...
router.get('/branch-performance', async (_req: AuthRequest, res: Response): Promise<void> => {
  try {
...
router.get('/branches/:id/performance', async (req: AuthRequest, res: Response): Promise<void> => {
  const { id } = req.params;
  try {
    ...
    const last7: { date: string; revenue: number }[] = Array.from({ length: 7 }, (_, i) => {
      const d = new Date();
...
router.get('/staff/elevated', async (_req: AuthRequest, res: Response): Promise<void> => {
  try {
...
router.get('/reports/sales-data', async (req: AuthRequest, res: Response): Promise<void> => {
...
router.post('/branches', async (req: AuthRequest, res: Response): Promise<void> => {
  try {
...
router.delete('/branches/:id', async (req: AuthRequest, res: Response): Promise<void> => {
  try {
...
router.delete('/staff/:id', async (req: AuthRequest, res: Response): Promise<void> => {
  try {
